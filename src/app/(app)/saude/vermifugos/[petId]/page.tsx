...
export default function PetVermifugosPage() {
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Controle de Vermifugação de {pet.nome}</CardTitle>
          <CardDescription>
            Visualize o histórico e adicione novos registros de vermifugação.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-4 text-right">
            <Button asChild>
              <Link href={`/saude/vermifugos/${pet.id}/new`}>
                <PlusCircle className="mr-2 h-4 w-4" /> Registrar Vermífugo
              </Link>
            </Button>
          </div>
          <p className="text-muted-foreground">
            Funcionalidade de listagem de vermífugos e calendário de aplicação será implementada aqui.
          </p>
          {/* TODO: Listar DewormerLogs e implementar calendário */}
        </CardContent>
      </Card>
    </div>
  );
