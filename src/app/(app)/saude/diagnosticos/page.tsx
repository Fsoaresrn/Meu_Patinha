...
import { AlertTriangle, Stethoscope, ChevronRight, Info } from "lucide-react"; 
...
function PetSelectionCard({ pet }: { pet: Pet }) {
  ...
  return (
    <Link href={`/saude/diagnosticos/${pet.id}/sintomas`} className="block group">
    ...
    <div className="container mx-auto py-8 px-4">
      <Card className="max-w-3xl mx-auto shadow-lg border-primary/20">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold text-primary">Diagnósticos - Análise de Sintomas com IA</CardTitle>
